...
(function($){
	flux.slider = function(elem, opts) {
		...
		this.container = $('<div class="fluxslider" style="width:100%"></div>').appendTo(this.element);

		this.surface = $('<div class="surface" style="position: fixed"></div>').appendTo(this.container);
